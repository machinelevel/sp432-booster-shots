//                          ^^
// To run this, click the Result tab.
//-----------------------------------
// Github: https://github.com/machinelevel/sp432-booster-shots
...
function MultiRunData()
{
    ...
    this.print_svg_to_string_v2 = function()
    {
        ...
        var msg_jump1 = 'Average was ' + dollar_text(total_jump_dollars / total_nz_jumpers) + ' for ' + (total_jump_dollars / (total_nz_jumpers * this.bump_price * this.num_slots_per_day)).toFixed(0) + ' days, '
                        + 'max was ' + dollar_text(max_jump_slots * this.bump_price) + ' for ' + max_jump_days + ' days.';
...
function run_simulations()
{
    ...
    if (num_sims == 1)
        brag_box.innerHTML = 'Running a sim with ' + comma_text(number_of_doses) + ' people...';
    else
        brag_box.innerHTML = 'Averaging ' + comma_text(num_sims) + ' sims with ' + comma_text(number_of_doses) + ' people...';
    ...
    if (num_sims == 1)
        brag_box.innerHTML = 'Finished sim with ' + comma_text(number_of_doses) + ' people in ' + elapsed_time.toFixed(3) + ' seconds.';
    else
        brag_box.innerHTML = 'Finished ' + comma_text(num_sims) + ' sims with ' + comma_text(number_of_doses) + ' people in ' + elapsed_time.toFixed(3) + ' seconds.';
